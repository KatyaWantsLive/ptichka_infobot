...
Прототип нейронной сети, определяющий на начальной версии 2 класса(возможно увеличение объема классов в будущем) и обученная на датасете состоящего из 5000 фотографий различных предметов из металла и пластика
### Классы:
- Металл
- Пластик
### Параметры обучения:
